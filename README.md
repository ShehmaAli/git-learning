...
# 🔀 Git Merge & Pull Requests – Notes & Cheat Sheet

This guide covers **merging branches in Git** and creating **pull requests (PRs)** using platforms like GitHub, GitLab, and Bitbucket.
